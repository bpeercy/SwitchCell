%Graphs for Figure 8 in "Flipping the switch on the hub cell: Islet
%desynchronization through cell silencing"


%Subfigure A
[t,x]=silencingSSCM('Fig8Parameters.mat',0);
Ca=interp1(t,x(:,3*57+1:4*57),0:300);
F=computeFuncConn(0:300,Ca);
PowerLawHist(F);

%Subfigure B
[t2,x2]=silencingSSCM('Fig8Parameters.mat',57);
Ca2=interp1(t2,x2(:,3*57+1:4*57),0:300);
F2=computeFuncConn(0:300,Ca2);
funcConnVisualization(F, F2,57)
